...
public static class TransformExtention
{
    ...
    public static void SetPosition(this Transform transform, Vector3 v)
    {
    ...
    public static void SetLocalPosition(this Transform transform, Vector3 v)
    {
    ...
    public static void SetEulerAngles(this Transform transform, float v)
    {
        _TempV3A.Set(v, v, v);
        transform.eulerAngles = _TempV3A;
    }
    ...
    {
        transform.SetLocalPosition(transform.localPosition.x + v.x, transform.localPosition.y + v.y, transform.localPosition.z + v.z);
    }
    ...
    #endregion SmoothStepLocalPosition
    ...
    #endregion SmoothStepEulerAngles
    ...
    #endregion SmoothStepLocalEulerAngles
    ...
    #endregion SmoothStepLocalScale
    ...
    #endregion ClampLocalEulerAngles
...
#if UNITY_4_3
    public static T GetComponentInParent<T> (this Transform self) where T : UnityEngine.Component
    {
